  ...
  return (
    <div>
      ...
      <nav className="bg-gray-100 p-4 flex gap-4 text-sm border-b">
        <NavLink to="/mitglieder" className={linkClass}>
          Mitglieder
        </NavLink>
        <NavLink to="/abteilungen" className={linkClass}>
          Abteilungen
        </NavLink>
        <NavLink to="/gruppen" className={linkClass}>
          Gruppen
        </NavLink>
      </nav>
      ...
      <div className="p-6">
        <Routes>
          <Route path="/" element={<Navigate to="/mitglieder" />} />{" "}
          {/* Weiterleitung */}
